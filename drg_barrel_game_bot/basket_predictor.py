...
# from .detectors import HSVBasketDetector
# from .border_manager import BorderManager

# class BasketPredictor:
#     '''Class for predicting basket next position and time to necessery position'''
#     def __init__(self, detector, border_manager: BorderManager,
#                  time_of_positions: float) -> None:
...
#                 right_border = self.border_manager.get_right_border()
#                 left_border = self.border_manager.get_left_border()
...
#         left_border, right_border = self.border_manager.get_left_border(), self.border_manager.get_right_border()
